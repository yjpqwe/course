                ...
                <div class="footer-inner">
                    <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">yanjinpeng</span>
							在线视频课程 &copy; 2011-2012
						</span>
    ...
    export default {
        ...
        methods: {
            ...
            activeSidebar: function (id) {
                //兄弟菜单去掉active样式，自身增加active样式 二级菜单
                $("#"+id).siblings().removeClass("active");
                $("#"+id).siblings().find("li").removeClass("active");
                $("#"+id).sibling().addClass("active");

                //如果有父菜单，父菜单的兄弟菜单去掉open active，父菜单增加open active 一级菜单
